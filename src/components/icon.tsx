...
export function Icon({ name, className = "h-5 w-5" }: IconProps) {
  ...
  switch (name) {
    ...
    case "food":
      return <svg {...common}><circle cx="12" cy="12" r="7" /><path d="M4 4v7a2 2 0 0 0 2 2h1M6 4v16M9 4v7M18 4v16M18 4c2.2 2 2.2 6 0 8" /></svg>;
    case "media":
      return <svg {...common}><rect x="3" y="5" width="18" height="14" rx="2.5" /><path d="m10 9 5 3-5 3V9Z" /><path d="M7 5 9 2M13 5l2-3" /></svg>;
    case "expenses":
